...
test('Update Product', async () => {
  ...
  const mockResponse = {
    ...
    date_modified: "2024-03-14T23:37:38",
    date_modified_gmt: "2024-03-14T18:07:38",
    type: "simple",
    status: "publish",
    featured: false,
    ...
    grouped_products: [],
    menu_order: 0,
    price_html: "<span class=\"woocommerce-Price-amount amount\"><bdi><span class=\"woocommerce-Price-currencySymbol\">&#36;</span>24.54</bdi></span>",
    related_ids: [],
    meta_data: [
      {
        id: 1039,
